...
class CraftingManager {
  ...
  bool checkForRecipe() {
    if (isInPlayerInventory()) {
      for (int index = 0; index < Recipe.playerInventoryGridRecipe.length; index++) {
        Recipe recipe = Recipe.playerInventoryGridRecipe[index];

        if (recipe.recipe.hasMatch(turnCraftingGridIntoAString(playerInventoryCraftingGrid, recipe.key))) {
      ...
      for (int index = 0; index < Recipe.standardGridRecipe.length; index++) {
        ...
        if (recipe.recipe.hasMatch(turnCraftingGridIntoAString(standardCraftingGrid, recipe.key))) {
