...
class RespawnScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (GlobalGameReference.instance.gameReference.worldData.playerData.playerIsDead.value) {
            ...
            children: [
              ...
              Padding(
                ...
                child: MinecraftButtonWidget(
                  text: "Respawn",
                  onPressed: () {
                    GlobalGameReference.instance.gameReference.worldData.playerData.playerIsDead.value = false;

                    GlobalGameReference.instance.gameReference.resumeEngine();

                    GlobalGameReference.instance.gameReference.playerComponent = PlayerComponent();

                    GlobalGameReference.instance.gameReference.add(GlobalGameReference.instance.gameReference.playerComponent);
