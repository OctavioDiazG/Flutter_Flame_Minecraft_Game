                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Image.asset("assets/images/launcher/new_world_icon.jpg"),),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                          worldName,
                          style: GameMethods.instance.minecraftTextStyle.copyWith(color: Colors.grey[400]),
                        ),
                        Text(
                          "Seed: $seed",
                          style: GameMethods.instance.minecraftTextStyle.copyWith(color: Colors.grey, fontSize: 15),
                        )
                      ],
                    )
                  ],
